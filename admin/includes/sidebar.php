<aside
    ...
    <div class="collapse navbar-collapse w-auto max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php echo ($current_page == 'programmer_livraison.php') ? 'active' : ''; ?>"
                    href="programmer_livraison.php"
                    style="<?php echo ($current_page == 'programmer_livraison.php') ? 'background-color: #0dcaf0;' : ''; ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="moreOptions">
                    <ul class="nav flex-column ms-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white <?php echo ($current_page == 'livraisons_table_display.php') ? 'active' : ''; ?>"
                                href="livraisons_table_display.php"
                                style="<?php echo ($current_page == 'livraisons_table_display.php') ? 'background-color: #0dcaf0;' : ''; ?>">Livraisons
                            </a>
                        </li>
                    </ul>
                </div>
