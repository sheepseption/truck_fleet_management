            ...
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <div class="card-body">
                    ...
                    if (isset($_GET['id']) && !empty($_GET['id'])) {
                        ...
                        $fetchQuery = "SELECT * FROM drivers WHERE id = ?";
                        ...
                        if (isset($_POST['update_btn'])) {
                            ...
                            $updateQuery = "UPDATE driver SET name = ?, email = ?, phone = ?, address = ? WHERE id = ?";
                            $updateStmt = mysqli_prepare($connection, $updateQuery);
                            mysqli_stmt_bind_param($updateStmt, 'ssssi', $name, $email, $phone, $address, $driverId);
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control shadow-sm border-primary" id="emailInput"
                                name="email" value="<?php echo $driver['email']; ?>" required>
                        </div>
                        <div class="mb-3">
